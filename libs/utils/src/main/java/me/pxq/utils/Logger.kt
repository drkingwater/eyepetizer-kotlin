...
//分级日志
inline fun <reified T> T.logi(msg :String) = Log.i("$APP_TAG-${T::class.java}", msg)

//fun logd(tag :String, msg :String) = Log.d("$APP_TAG-$tag", msg)
inline fun <reified T> T.logd(msg :String) = Log.d("$APP_TAG-${T::class.java}", msg)

//fun loge(tag :String, msg :String) = Log.e("$APP_TAG-$tag", msg)
inline fun <reified T> T.loge( msg :String) = Log.e("$APP_TAG-${T::class.java}", msg)
